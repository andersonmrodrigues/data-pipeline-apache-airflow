from pystark.sql import SparkSession
from pyspark.sql.fuctions import col, when, to_date, countDistinct, sum, date_format
...
if __name__ == "__main__":
    ...
    tweet = spark.read.json(
        "/Users/anderson.rodrigues/Documents/workspace/datapipeline",
    ...
    tweet.coalesce(1)\
        .write\
        .json("/Users/anderson.rodrigues/Documents/workspace/tools/datapipeline/datalake/gold/twitter_insight_tweet")
